...
fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> u_colorTex [[texture(0)]], sampler u_colorTexSmplr [[sampler(0)]])
{
    main0_out out = {};
    float2 param = in.inTexCoord * float2(1920.0, 1080.0);
