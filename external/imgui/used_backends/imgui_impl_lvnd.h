...
IMGUI_IMPL_API bool     ImGui_ImplLvnd_InitForOpenGL(LvndWindow* window, bool install_callbacks);
...
// Lvnd callbacks (individual callbacks to call if you didn't install callbacks)
